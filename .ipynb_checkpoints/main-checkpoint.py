...
def main(t1c_path, t1n_path, t2w_path, t2f_path, output_path):
    # t2f_path = copy_to_workspace(t2f_path, "fused_t1c_t1n.nii.gz")
    # t2f_path = copy_to_workspace(t2f_path, "fused_t1c_t2f.nii.gz")
    # t2f_path = copy_to_workspace(t2f_path, "fused_t1c_t2w.nii.gz")
