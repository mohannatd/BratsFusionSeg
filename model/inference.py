...
def run_inference(output_path):
    ...
    os.system(f"nnUNetv2_predict -i {nnUNet_raw} -o {output_path} -d 13 -c 3d_fullres -f all -tr nnUNetTrainerDiceCELoss_noSmooth -npp 1 -nps 1 --disable_tta --disable_progress_bar")
